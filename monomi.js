...
client.on("message", (message) => { //When a message is sent.
	...
	if (command === "roster" || command === "class" || command === "r") {
		...
		studentID = "";
		if (message.guild.id != "598739324464267274" && message.guild.id != "617202043597226009") { //All but GA server
			...
			classList = [
				...
				{ studentID: "Name: Daichi Lastname\nTalent: Talent\nSex: Male\nStatus: Alive\n\nShoe Size: #\nHeight: #'#\"\nWeight: 1##\nBlood Type: \_\nBirthday: ##/##\nAge: 1#", studentIDPicture: "" },
			...
			if (args[0] === "total") {
				...
				message.channel.send("```10  M Adam Satou                10           5'11\"     160       AB            08/06       17      Stenographer\n11  M Amon Nkosi Kazumi Femi    8            6'0\"      164       AB            02/01       17      Romantic\n12  M Daichi                    #            #'#\"      1##       _             ##/##       1#      Talent\n13  M Kaoru Saitou              11           5'10\"     150       AB            07/04       16      Survivalist\n14  M Pippin Barley Malt        12           6'10\"     152       N/A           N/A         N/A     Confectioner\n15  M Tomomi Kashichi           10.5         5'8\"      137       A             04/27       17      Technician\n16  M Xiao Ruohan               5            5'3\"      110       AB            01/23       15      Qin Player\n17  . Ash Character B           #            #'#\"      1##       _             ##/##       1#      Talent\n18  . Nathan Character B        #            #'#\"      1##       _             ##/##       1#      Plague Doctor\n\n	Mastermind\n    Information Unavailable.\n\n    Deceased Students\n    Soon.```");
